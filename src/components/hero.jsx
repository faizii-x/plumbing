  ...
  return (
    <>
      <div className="slider-container ">
        <Slider {...settings}>
          <div className=" w-full h-auto bg-cover bg-center imagebg sm:p-[160px] p-[10px]">
            <p className=" bg-white lg:w-[50%] md:w-[70%] md:mt-0 mt-[100px] text-black mx-auto text-center text-[32px] font-poppins font-bold ">
              Expert Demolition Services
            </p>
            <p className="text-white mt-3  mx-auto font-semibold text-[22px]">
          ...
          <div className=" w-full h-auto bg-cover bg-center imagebgg sm:p-[160px] p-[10px]">
            <p className=" bg-white lg:w-[50%] md:w-[70%] md:mt-0 mt-[100px] text-black mx-auto text-center text-[32px] font-poppins font-bold ">
              <span style={{ backgroundColor: "rgba(255, 255, 255, 0.5)" }}>
                Reliable Plumbing Solutions
              </span>
            </p>
            <p className="text-white mt-3 font-semibold mx-auto text-[22px]">
